...
export default function MarketScreen() {
  ...
  function openVendorAuth(mode: SellerMode = "signup") {
    setSellerOpen(false);
    router.push({
    ...
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.topActions}>
          <Pressable style={styles.sellerButton} onPress={() => openVendorAuth("signup")}>
      ...
      >
        ...
        <VendorBanner onPress={() => openVendorAuth("signup")} />
